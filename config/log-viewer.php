...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | When enabled, Log Viewer requires LOG_VIEWER_USERNAME and LOG_VIEWER_PASSWORD.
    | Missing credentials deny all access (fail closed).
    |
    */

    'basic_auth' => [
        'enabled' => env('LOG_VIEWER_BASIC_AUTH_ENABLED', true),
